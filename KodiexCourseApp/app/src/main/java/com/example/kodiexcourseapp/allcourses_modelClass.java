...
//     List<String>list_curriculum_link=new ArrayList<>();
    ...
    public allcourses_modelClass(List<String> list_image_url,List<String> list_courses_keys, List<String> list_instructor, List<String> list_lectures, List<String> list_level, List<String> list_price, List<String> list_rating, List<String> list_subject, List<String> list_title) {
